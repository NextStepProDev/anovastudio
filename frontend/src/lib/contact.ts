...
export const CONTACT = {
  ...
  /** Profile społecznościowe. TODO: PODMIENIĆ na właściwe adresy przed wdrożeniem —
      teraz TYMCZASOWE placeholdery (strony główne FB/IG), żeby był widoczny układ.
      Renderowane tylko gdy != null (wzorzec jak bookingUrl). */
